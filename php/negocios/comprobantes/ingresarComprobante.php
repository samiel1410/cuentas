...
$ingresar= new metodosComprobante();
$ingresar->insertarComprobante(
    $id_fkforma_pago_comprobante,$concepto_comprobante,$fecha_creacion_comprobante,$fecha_cobro_comprobante,$id_fkusuario_comprobante,$id_fksucursal_comprobante,$abono_comprobante,$id_fkorden_pedido_comprobante);
